"""
Generic OpenAI-compatible provider implementation for AI API Failover Router.
"""
...
class GenericProvider(BaseProvider):
    ...
    Supports any OpenAI API-compatible endpoint (vLLM, LocalAI, etc.).
    ...
    async def complete(
        ...
        **kwargs
        ...
        """Execute a completion request to generic OpenAI-compatible API."""
    ...
    async def health_check(self) -> HealthStatus:
        """Check if the generic API is responsive."""
        try:
            async with aiohttp.ClientSession() as session:
                headers = {}
                if self.api_key:
    ...
    def normalize_response(
        ...
        """Convert OpenAI-compatible response to normalized format."""
